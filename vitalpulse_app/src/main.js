...
function initAdminNavigation() {
    ...
    if (btnCloseCampaignModal) {
        btnCloseCampaignModal.addEventListener('click', () => {
            const modal = document.getElementById('campaignModal');
            if (modal) { modal.classList.add('hidden'); modal.classList.remove('flex'); }
        });
    }

    // Modal close & submit button fallbacks
    document.getElementById('btnCloseCompatBottom')?.addEventListener('click', () => {
        const modal = document.getElementById('compatModal');
        if (modal) { modal.classList.add('hidden'); modal.classList.remove('flex'); }
    });
    document.getElementById('btnSubmitLabTest')?.addEventListener('click', () => {
        const form = document.getElementById('formLabTest') || document.getElementById('labTestForm');
